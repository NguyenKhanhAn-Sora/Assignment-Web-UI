...
function sliderProductAll(leftControl, rightControl, cart, container, currentPage, totalPage) {
    ...
    leftControl.addEventListener('click', function() {
        ...
        if(productCheckPage==(Math.ceil(cart.length/4))-1) {
            if(cart.length%4==1) {
                container.style.transform = `translateX(-${productCheckPage*(cart[0].offsetWidth+15)*4-(cart[0].offsetWidth+15)*3}px)`
            }
            else if(cart.length%4==2) {
                container.style.transform = `translateX(-${productCheckPage*(cart[0].offsetWidth+15)*4-(cart[0].offsetWidth+15)*2}px)`
                
            }
            else if(cart.length%4==3) {
                container.style.transform = `translateX(-${productCheckPage*(cart[0].offsetWidth+15)*4-(cart[0].offsetWidth+15)*1}px)` 
            }
            else if(cart.length%4 == 0) {
                container.style.transform = `translateX(-${productCheckPage*((cart[0].offsetWidth+15)*4)}px)`
            }
        }
        else {
            container.style.transform = `translateX(-${productCheckPage*((cart[0].offsetWidth+15)*4)}px)`
    ...
    leftControl.addEventListener('click', function() {
        ...
        if(productCheckPage<0) {
            ...
            if(cart.length%4==1) {
                container.style.transform = `translateX(-${productCheckPage*((cart[0].offsetWidth+15)*4)-((cart[0].offsetWidth+15)*4)}px)`
            }
            else if(cart.length%4==2) {
                container.style.transform = `translateX(-${productCheckPage*(cart[0].offsetWidth+15)*4-(cart[0].offsetWidth+15)*3}px)`
        ...
        if(productCheckPage==(Math.ceil(cart.length/2))-1) {
            if(cart.length%2==1) {
                container.style.transform = `translateX(-${productCheckPage*(cart[0].offsetWidth+15)*2-(cart[0].offsetWidth+15)*1}px)`
            }
            else if(cart.length%2==0) {
                container.style.transform = `translateX(-${productCheckPage*((cart[0].offsetWidth+15)*2)}px)`
            }
        }
        else {
            console.log(productCheckPage);
